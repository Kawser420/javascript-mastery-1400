...
const Header: React.FC<HeaderProps> = ({ currentTheme, setTheme, onLoginClick, onSignupClick, isAuthenticated, username, onLogout, onToggleSidebar }) => {
      ...
      <div className="navbar-start">
         <div className="lg:hidden">
            <button onClick={onToggleSidebar} className="btn btn-square btn-ghost">
              <svg xmlns="http://www.w.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
            </button>
        </div>
        <a href="#" className="btn btn-ghost text-xl normal-case">
          <svg xmlns="http://www.w.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" /></svg>
          JS Mastery
        </a>
      </div>

      ...
      <div className="hero-content text-center">
        <div className="max-w-xl">
          ...
          <p className="py-6 text-lg">
            ...
            library of 500+ interactive challenges. Sharpen your skills with our
            scientific calculator and get instant, in-depth explanations from
            our Gemini-powered AI assistant.
          </p>
          <a
            href="#problems"

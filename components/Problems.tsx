        ...
        <section id="problems" className="py-24 px-4 md:px-8 bg-base-200 scroll-mt-20">
            <div className="container mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-lg text-base-content/70">Test your knowledge with our library of {problems.length}+ interactive problems.</p>
                </div>
                ...
                <div className="flex justify-center mb-12">
                    <div className="tabs tabs-boxed bg-base-100/50 p-2 flex-nowrap overflow-x-auto">
                        <button 
                            className={`tab tab-lg ${selectedCategory === 'All' ? 'tab-active' : ''}`}
                        ...
                        {availableCategories.map(category => (
                            <button 
                                key={category}
                                className={`tab tab-lg whitespace-nowrap ${selectedCategory === category ? 'tab-active' : ''}`}

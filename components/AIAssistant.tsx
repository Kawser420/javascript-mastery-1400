        ...
        {parts.map((part, index) => {
          if (part.startsWith("```") && part.endsWith("```")) {
            ...
            return (
              <div
                key={index}
                className="mockup-code text-sm my-2 bg-neutral text-neutral-content"
              >
                <pre>
...
const AIAssistant: React.FC = () => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      sender: "ai",
      text: "Hi there! I'm your JavaScript assistant, powered by Gemini. Ask me to explain a concept, debug your code, or solve a problem!",
    },
  ]);

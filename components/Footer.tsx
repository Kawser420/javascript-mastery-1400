    ...
    return (
        <footer className="footer p-10 bg-base-200 text-base-content">
            <nav>
                ...
                <a className="link link-hover">Beginner Basics</a>
                <a className="link link-hover">Functions & Scope</a>
                <a className="link link-hover">Arrays & Strings</a>
                <a className="link link-hover">Objects & Prototypes</a>
                <a className="link link-hover">ES6+ Features</a>
            </nav> 
            <nav>
            ...
            <form>
             ...
             <aside className="footer-center grid-flow-col-dense col-span-full mt-8 pt-8 border-t border-base-300">
                <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-start">
                   <p>Copyright © {new Date().getFullYear()} - All right reserved by JS Mastery Ltd</p>
                </div>

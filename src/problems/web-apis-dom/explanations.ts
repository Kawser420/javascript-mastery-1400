...
if (selectedColorInput) {
  console.log(selectedColorInput.value); // "green"
}
\`\`\`
### 📚 Key Concepts
...
\`\`\`javascript
const queryString = "q=js&page=2"; // Can be from window.location.search
...
requestIdleCallback((deadline) => {
  ...
  // Use deadline.timeRemaining() to check if you have enough time

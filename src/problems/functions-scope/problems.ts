...
export const problems: Problem[] = [
  {
    ...
    description: "Define a function that takes no arguments and returns a specific string.",
  ...
  },
  {
    ...
    description: "Rewrite a simple function that calculates the square of a number using arrow function syntax.",
    category: "Functions & Scope",
  ...
  },
  {
    ...
    description: "Create a function using the `function` keyword. This method is subject to hoisting.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show that a function expression assigned to a `var` is hoisted, but only the variable declaration, not the function assignment.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Write a pure function that takes a number and returns its value doubled. A pure function has no side effects.",
    category: "Functions & Scope",
  ...
  },
  {
    ...
    description: "Create a higher-order function that takes a number and a callback function, and applies the callback to the number.",
    category: "Functions & Scope",
  ...
  },
  {
    ...
    description: "Create a function that processes an array and executes a callback function for each item synchronously.",
    category: "Functions & Scope",
    inputs: [{ id: "arr", label: "Array (comma-separated)", type: "text", defaultValue: "apple, banana, cherry" }],
  ...
  },
  {
    ...
    category: "Functions & Scope",
    inputs: [{ id: "numbers", label: "Numbers (comma-separated)", type: "text", defaultValue: "10, 20, 30" }],
  ...
  },
  {
    ...
    category: "Functions & Scope",
    inputs: [{ id: "num", label: "Start from", type: "number", defaultValue: 5 }],
    buttonText: "Start Countdown",
  },
  {
    id: "first-class-functions",
    title: "First-Class Functions",
    description: "Demonstrate that functions are 'first-class citizens' by assigning a function to a variable and then invoking it.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Create a named function expression. The name is only accessible within the function itself, useful for debugging or recursion.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate the common pitfall of using `var` in a loop with an asynchronous callback, and how `let` solves it.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that primitive types are passed by value. Modifying them inside a function does not affect the original.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that objects are passed by reference. Modifying a property inside a function affects the original object.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show the syntax for the `Function` constructor. Note: This is generally not recommended due to security and performance reasons.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Use `.bind()` to create a partially applied function by pre-setting some arguments.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that `var` declarations are hoisted, but their assignments are not, resulting in `undefined`.",
    category: "Functions & Scope",
    inputs: [],
    buttonText: "Test `var` Hoisting",
  },
  ...
  },
  {
    ...
    category: "Functions & Scope",
    inputs: [{ id: "param", label: "Parameter to pass", type: "text", defaultValue: "Hello IIFE" }],
    buttonText: "Run IIFE with Param",
  },
  {
    id: "function-overwriting",
    title: "Function Overwriting",
    description: "Demonstrate how defining a function with the same name as a previous one will overwrite the original.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show a conceptual example of 'callback hell' or the 'pyramid of doom,' which modern Promises and async/await solve.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate the `.name` property of a function for both named and anonymous functions.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Use the iterator returned by a generator function with the `.next()` method to get yielded values.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Explain what a Lexical Environment is and its two components: the Environment Record and the reference to the outer environment.",
    category: "Functions & Scope",
    inputs: [],
    buttonText: "Explain",
  },
  {
    ...
    description: "Demonstrate the classic problem where `this` inside a `setTimeout` callback in a method is not what you expect, and show solutions.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Create a `compose` function that takes two functions and returns a new function that is their mathematical composition.",
    category: "Functions & Scope",
  ...
  },
  {
    ...
    description: "Create a `pipe` function that takes multiple functions and chains them together, passing the output of one as the input to the next.",
    category: "Functions & Scope",
    inputs: [{ id: "num", label: "Input Number", type: "number", defaultValue: 5 }],
  ...
  },
  {
    ...
    description: "Explain what a side effect is in the context of functions (e.g., modifying an external variable, logging to console, writing to a file).",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show how `let` creates a new lexical environment for each iteration of a `for` loop.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that arrow functions do not have a `.prototype` property and cannot be used as constructors.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show how a regular nested function inside a method gets its own `this` context (usually global), and how to solve it.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that default parameter expressions are evaluated at call time.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Explain function arity (the number of arguments a function expects) and show how the `.length` property reflects this.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Use the module pattern with an IIFE to create an object with public methods that can access private helper functions.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate functions as first-class citizens by storing them in an array and then iterating and calling them.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Create a variadic function (a function that accepts a variable number of arguments) using rest parameters to find the maximum number.",
    category: "Functions & Scope",
    inputs: [{ id: "numbers", label: "Numbers (comma-separated)", type: "text", defaultValue: "1, 5, 2, 9, 3" }],
    buttonText: "Find Max",
  },
  {
    id: "execution-context-conceptual",
    title: "Execution Context (Conceptual)",
    description: "Explain the two phases of the Execution Context: Creation (variable environment, `this` binding) and Execution.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate how the value of `this` is lost when a method is passed as a callback to another function (e.g., `forEach`).",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show a potential pitfall where a function declaration is unconditionally hoisted from within a block, leading to unexpected behavior.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Summarize the key differences between `.call()`, `.apply()`, and `.bind()` for controlling the `this` context.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Explain the subtle difference between currying (a series of unary functions) and partial application (fixing some arguments).",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Explain why JavaScript does not support traditional function overloading and how to achieve similar results by checking arguments.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Use a named function expression to allow a function to refer to itself, useful for recursion without being dependent on the variable it's assigned to.",
    category: "Functions & Scope",
    inputs: [{ id: "num", label: "Factorial of", type: "number", defaultValue: 4 }],
    buttonText: "Calculate Factorial",
  },
  {
    id: "closure-scope-preservation",
    title: "Closure Scope Preservation",
    description: "Demonstrate that a closure holds a reference to its scope, not a copy, by modifying a variable after the closure is created but before it's called.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Create a higher-order function that wraps another function to log its arguments and return value.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that functions created with the `Function` constructor do not create closures to their creation contexts; they always have global scope.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show how a `return` statement in a generator function sets the `value` of the final object where `done` is true.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Use `yield*` to delegate the iteration control from one generator to another.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that an `async` function always returns a Promise, which resolves with the function's return value.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Clarify that `this` inside a method defined in an object literal refers to the object itself.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Create an object where one of the property values is a function, and then call that function.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Explain what the Call Stack is and how it keeps track of function calls, including a simple example of `A()` calls `B()` calls `C()`.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Conceptually explain the order of precedence for `this` binding: `new` > explicit binding (`bind`, `call`) > method call > default (global).",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Outline the logic for creating a simple polyfill for the `Function.prototype.bind` method using closures and `.apply()`.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that default parameters have their own scope, which is between the parent scope and the function body's scope.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show the common pitfall of using an arrow function as a method directly on an object literal, where `this` does not refer to the object.",
    category: "Functions & Scope",
    inputs: [],
    buttonText: "Show Pitfall",
  },
  {
    ...
    description: "Write an impure function that sorts an array in place, and a pure function that returns a new, sorted array.",
    category: "Functions & Scope",
    inputs: [{ id: "arr", label: "Array", type: "text", defaultValue: "c,a,b" }],
    buttonText: "Sort Pure vs. Impure",
  },
  {
    id: "iife-with-global-variable",
    title: "IIFE with Global Variable",
    description: "Demonstrate passing a global object (like `window`) into an IIFE to explicitly define dependencies.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Write a function where some parameters are optional by checking if they are `undefined`.",
    category: "Functions & Scope",
  ...
  },
  {
    ...
    description: "Summarize the key advantages of using rest parameters (`...args`) over the older `arguments` object.",
    category: "Functions & Scope",
    inputs: [],
    buttonText: "Compare",
  },
  {
    ...
    description: "Write a function that accepts an object of named arguments and uses destructuring in the parameter list.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that calling `.toString()` on a function returns its source code as a string.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that a function can access global variables, but the global scope cannot access function-scoped variables.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Show that `const` is block-scoped like `let` but also cannot be reassigned.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Implement a simple version of the `forEach` method as a higher-order function that takes an array and a callback.",
    category: "Functions & Scope",
  ...
  },
  {
    ...
    description: "Create a curried function `log(level)(message)` for practical, specialized logging.",
    category: "Functions & Scope",
    inputs: [{ id: "msg", label: "Message", type: "text", defaultValue: "Request successful" }],
    buttonText: "Log with Curried Function",
  },
  {
    id: "this-in-event-listener-arrow",
    title: "`this` in Event Listener (Arrow)",
    description: "Conceptually show how an arrow function as an event listener inherits `this` from its surrounding scope, which is often desirable in classes.",
    category: "Functions & Scope",
    inputs: [],
  ...
  },
  {
    ...
    description: "Demonstrate that a function expression assigned to a `var` has its declaration hoisted, but the function body is not, leading to a `TypeError` if called early.",
    category: "Functions & Scope",
    inputs: [],
    buttonText: "Test Hoisting",
  }

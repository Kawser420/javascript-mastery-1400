...
export const problems: Problem[] = [
  ...
  },
  {
    ...
    description:
      "Implement a Singly Linked List with methods to `append`, `prepend`, `delete`, and `find`.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Doubly Linked List, which includes nodes with pointers to both the next and previous nodes.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a basic Hash Table class with `set`, `get`, and `remove` methods, including a simple hashing function.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Binary Search Tree (BST) class and an `insert` method that adds new values while maintaining the BST property.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Add a `find` method to the BST class that returns `true` if a value exists in the tree and `false` otherwise.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Implement the three main DFS traversal methods for a BST: In-order, Pre-order, and Post-order.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Implement a Breadth-First Search (BFS) traversal method for a Binary Search Tree, which visits nodes level by level.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Explain the two common ways to represent a graph: an Adjacency List and an Adjacency Matrix.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Depth-First Search (DFS) traversal for a graph represented by an Adjacency List.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Breadth-First Search (BFS) traversal for a graph represented by an Adjacency List.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Trie data structure with `insert` and `search` methods. A Trie is efficient for storing and retrieving strings.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Max Heap data structure with `insert` and `extractMax` methods. A heap is a specialized tree-based data structure.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Min Heap data structure with `insert` and `extractMin` methods.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Queue using two Stacks. The implemented queue should support the enqueue and dequeue operations.",
    category: "Data Structures",
    inputs: [],
    buttonText: "Test Queue",
  },
  {
    ...
    description:
      "Implement a Stack using two Queues. The implemented stack should support the push and pop operations.",
    category: "Data Structures",
    inputs: [],
    buttonText: "Test Stack",
  },
  ...
  },
  {
    ...
    description:
      "Write a function that determines if a linked list has a cycle in it.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Write functions to find the minimum and maximum values in a Binary Search Tree.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function to calculate the height (or depth) of a binary tree.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function to determine if a binary tree is height-balanced (the depths of the two subtrees of every node never differ by more than one).",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      {
        id: "arr",
        label: "Values to insert (JSON array with nulls)",
        type: "text",
  ...
  },
  {
    ...
    description:
      "Implement a Priority Queue using a Min Heap, supporting `enqueue` with a priority and `dequeue`.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the two common methods for handling hash collisions: Separate Chaining and Open Addressing (e.g., Linear Probing).",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Deque (double-ended queue) with methods like `addFront`, `addRear`, `removeFront`, and `removeRear`.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Add a method to the Trie class that returns all words with a given prefix.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement the `delete` method for a BST, handling the three cases: node is a leaf, node has one child, and node has two children.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain how to detect a cycle in a directed graph using DFS and tracking the recursion stack.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Demonstrate using a `Set` to efficiently find the number of unique elements in an array.",
    category: "Data Structures",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Use a `Map` to create a frequency counter for characters in a string.",
    category: "Data Structures",
    inputs: [
      {
        id: "str",
        label: "String to count",
        type: "text",
        defaultValue: "hello",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Write a function to find the in-order successor of a given node in a Binary Search Tree.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Topological Sort algorithm for a Directed Acyclic Graph (DAG), used for ordering tasks with dependencies.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain how to design a Least Recently Used (LRU) cache using a combination of a Hash Map and a Doubly Linked List for O(1) performance.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Given a sorted array, write a function to convert it into a height-balanced Binary Search Tree.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Graph class using an Adjacency List with methods to add vertices and edges.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Given a 2D grid map of '1's (land) and '0's (water), count the number of islands using DFS or BFS.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Design an algorithm to serialize a Binary Search Tree to a string and deserialize the string back to the BST.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the concept of an AVL tree as a self-balancing binary search tree and the rotations (LL, RR, LR, RL) used to maintain balance.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the concept of a Red-Black Tree, another type of self-balancing BST with specific rules for node coloring.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the concept of a B-Tree, a self-balancing tree data structure that maintains sorted data and is commonly used in databases and filesystems.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the concept of a Bloom Filter, a space-efficient probabilistic data structure used to test whether an element is a member of a set.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the concept of a Skip List, a probabilistic data structure that allows for fast search within an ordered sequence of elements, like a linked list with 'express lanes'.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain Prim's algorithm for finding a Minimum Spanning Tree (MST) for a weighted undirected graph.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain Kruskal's algorithm, another greedy algorithm for finding a Minimum Spanning Tree (MST).",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Disjoint Set Union data structure, which keeps track of a set of elements partitioned into a number of disjoint (non-overlapping) subsets. It has two primary operations: `find` and `union`.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Fenwick Tree, a data structure that can efficiently update elements and calculate prefix sums in an array of numbers.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Segment Tree, a tree data structure used for storing information about intervals or segments. It allows querying which of the stored segments contain a given point.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "You have two numbers represented by a linked list, where each node contains a single digit. The digits are stored in reverse order. Write a function that adds the two numbers and returns the sum as a linked list.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Bellman-Ford algorithm for finding the shortest paths from a single source vertex to all other vertices in a weighted digraph, which can handle negative edge weights.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Floyd-Warshall algorithm for finding the shortest paths between all pairs of vertices in a weighted graph (all-pairs shortest path problem).",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Implement a Circular Queue using a fixed-size array. This is an efficient way to implement a queue that avoids the O(n) cost of `shift()`.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Add a method to the Trie class to delete a word, which involves removing nodes that are no longer part of any other word.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    title: "Heap: Heapify",
    description:
      "Explain the 'heapify' process, an efficient O(n) algorithm to build a heap from an unsorted array.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain how to determine if a graph is bipartite (its vertices can be divided into two disjoint sets such that every edge connects a vertex in one set to one in the other) using BFS or DFS and coloring.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain how to calculate the sum of a range `[i, j]` using a Fenwick Tree by computing `query(j) - query(i-1)`.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain how to perform a range update (e.g., add a value to all elements in a range `[i, j]`) on a Segment Tree using lazy propagation.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Sparse Table data structure, used for answering range query problems (like Range Minimum Query) in O(1) time after an O(n log n) preprocessing step.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the Suffix Array, a data structure that provides a sorted list of all suffixes of a string, used for complex string searching problems.",
    category: "Data Structures",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Explain the K-D Tree, a space-partitioning data structure for organizing points in a k-dimensional space, used for range searches and nearest neighbor searches.",
    category: "Data Structures",
    inputs: [],

...
export const problems: Problem[] = [
  {
    ...
    title: "Say Hello",
    description:
      "Write a function that takes a name as a string and returns a greeting message.",
  ...
  },
  {
    ...
    description:
      "Write a function that finds the remainder of a division using the modulo operator (%).",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Calculate the result of a number raised to the power of another number.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Write a function that takes a number and returns the number incremented by 1.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Write a function that takes a number and returns the number decremented by 1.",
    category: "Beginner Basics",
    inputs: [{ id: "num", label: "Number", type: "number", defaultValue: 5 }],
  ...
  },
  {
    ...
    description:
      "Write a function that explicitly converts a number to its string representation.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    title: "Get Data Type",
    description:
      "Write a function that takes any value and returns its data type using the `typeof` operator.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "value",
  ...
  },
  {
    ...
    description:
      "Compare two values for strict equality (both value and type must match).",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Compare two values for loose equality (values are coerced to the same type before comparison).",
    category: "Beginner Basics",
    inputs: [
      { id: "val1", label: "Value 1", type: "text", defaultValue: "5" },
      { id: "val2", label: "Value 2", type: "text", defaultValue: "5" },
  ...
  },
  {
    ...
    description:
      "Write a function that returns true if the first number is greater than the second, and false otherwise.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    title: "Logical AND (&&)",
    description:
      "Write a function that checks if a person is old enough AND has a license to drive.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    title: "Logical OR (||)",
    description:
      "Write a function that checks if a user is either an Admin OR the content owner to allow editing.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "isAdmin",
        label: "Is Admin? (true/false)",
        type: "text",
        defaultValue: "false",
      },
      {
        id: "isOwner",
        label: "Is Owner? (true/false)",
        type: "text",
        defaultValue: "true",
      },
    ],
  ...
  },
  {
    ...
    title: "Logical NOT (!)",
    description:
      "Write a function that inverts a boolean value using the NOT operator.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "value",
  ...
  },
  {
    ...
    description:
      'Write a function that returns "Can vote" if age is 18 or over, and "Cannot vote" otherwise.',
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Assign a letter grade (A, B, C, D, F) based on a score using if-else if-else.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Use the ternary operator to check if a user is logged in and return an appropriate message.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "isLoggedIn",
  ...
  },
  {
    ...
    description:
      "Write a function to determine if a given year is a leap year. A year is a leap year if it is divisible by 4, except for end-of-century years, which must be divisible by 400.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Use a switch statement to return the day of the week from a number (1=Sunday, 2=Monday, etc.).",
    category: "Beginner Basics",
    inputs: [
      {
        id: "dayNum",
  ...
  },
  {
    ...
    category: "Beginner Basics",
    inputs: [
      { id: "num", label: "Loop until", type: "number", defaultValue: 5 },
    ],
  ...
  },
  {
    ...
    description:
      "Use a for loop to calculate the sum of all numbers from 1 up to a given number.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Use a while loop to generate a string of numbers, incrementing by 2, until the number is greater than 10.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Write a function that returns the element at a specific index from an array.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that returns the total number of elements in an array.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that converts an entire string to its uppercase equivalent.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    description:
      "Write a function that converts an entire string to its lowercase equivalent.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    inputs: [
      {
        id: "value",
        label: 'Input value (try typing "null")',
        type: "text",
        defaultValue: "hello",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Write a function that checks if a given value is `undefined`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "value",
        label: 'Input value (try typing "undefined")',
        type: "text",
        defaultValue: "123",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Write a function that extracts a portion of a string using `slice()`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    description:
      "Write a function that joins all elements of an array into a string using a specified separator.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that returns the absolute value of a number using `Math.abs()`.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Write a function that rounds a number up to the next largest integer using `Math.ceil()`.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Write a function that rounds a number down to the nearest integer using `Math.floor()`.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Write a function that rounds a number to the nearest integer using `Math.round()`.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Write a function that generates a random integer between a min and max value (inclusive).",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Write a function that removes whitespace from both the beginning and end of a string.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    description:
      "Write a function that replaces the first occurrence of a substring with a new substring.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    description:
      "Write a function that splits a sentence into an array of words.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    description:
      "Write a function that adds a new element to the end of an array using `.push()`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that removes and returns the last element of an array using `.pop()`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that removes and returns the first element of an array using `.shift()`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that adds a new element to the beginning of an array using `.unshift()`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that checks if an array contains a certain value.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Write a function that finds the index of the first occurrence of a specified element in an array.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
        label: "Array (comma-separated)",
        type: "text",
        defaultValue: "apple,banana,cherry,banana",
      },
      {
        id: "value",
        label: "Value to find",
  ...
  },
  {
    ...
    description:
      "Write a function that creates a new array containing a portion of an existing array.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    title: "Do...While Loop",
    description:
      "Use a `do...while` loop to create a countdown that executes at least once, even if the condition is initially false.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "num",
  ...
  },
  {
    ...
    description:
      "Use a `for...of` loop to iterate over the values in an array and create a new string.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    title: "Check for NaN",
    description:
      "Write a function that checks if a value is `NaN` (Not-a-Number).",
    category: "Beginner Basics",
    inputs: [
      {
        id: "value",
  ...
  },
  {
    ...
    description:
      "Write a function to calculate the square root of a number using `Math.sqrt()`.",
    category: "Beginner Basics",
  ...
  },
  {
    ...
    description:
      "Use a template literal to create a string that includes the result of an arithmetic expression.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Write a function to get the character at a specific index in a string using `.charAt()`.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Create an object literal representing a book with title and author properties.",
    category: "Beginner Basics",
    inputs: [],
  ...
  },
  {
    ...
    category: "Beginner Basics",
    inputs: [
      { id: "price", label: "New Price", type: "number", defaultValue: 12.99 },
    ],
  ...
  },
  {
    ...
    description:
      "Add a new property `inStock` with a boolean value to a product object.",
    category: "Beginner Basics",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Write a function that checks if a number is positive and then checks if it is even.",
    category: "Beginner Basics",
    inputs: [{ id: "num", label: "Number", type: "number", defaultValue: 10 }],
    buttonText: "Check Number",
  },
  {
    ...
    description:
      "Use a switch statement where multiple cases execute the same code block (fall-through).",
    category: "Beginner Basics",
    inputs: [
      {
        id: "day",
  ...
  },
  {
    ...
    description:
      "Write a function that converts a string to a whole number using `parseInt()`.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "str",
  ...
  },
  {
    ...
    description:
      "Use the `continue` statement to skip the current iteration of a loop and move to the next.",
    category: "Beginner Basics",
    inputs: [
      {
        id: "arr",
  ...
  },
  {
    ...
    description:
      "Combine two arrays into a new single array using the `.concat()` method.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Format a number to a specific number of decimal places, returning a string representation.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Create an array literal containing three different colors as strings.",
    category: "Beginner Basics",
    inputs: [],
  ...
  },
  {
    ...
    description:
      "Reverse the order of elements in an array in place using the `.reverse()` method.",
    category: "Beginner Basics",
    inputs: [
  ...
  },
  {
    ...
    description:
      "Demonstrate JavaScript's type coercion by adding a number to a string.",
    category: "Beginner Basics",
    inputs: [],

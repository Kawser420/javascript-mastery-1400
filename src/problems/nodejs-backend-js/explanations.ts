...
- **`__filename`**: A string containing the absolute path of the currently executing script file.
- **`__dirname`**: A string containing the absolute path of the directory that the currently executing script file is in.

### ⚙️ Solution Walkthrough
In a script located at `/Users/me/project/src/app.js`:
-   `console.log(__filename);` would output `/Users/me/project/src/app.js`.
-   `console.log(__dirname);` would output `/Users/me/project/src/app.js`.
